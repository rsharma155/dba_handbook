/*
================================================================================
Overlapping Statistics Detection (Auto-created vs Index/User Stats)
================================================================================
Description:
    Finds auto-created statistics that overlap existing index or user statistics on the same leading column (SQL 2008+), including filtered-stats awareness. Overlapping auto-stats waste maintenance and can confuse cardinality estimates.

Source Attribution:
    Adapted from Kendal Van Dyke's SQL-Server-Scripts
    https://github.com/kendalvandyke/SQL-Server-Scripts
    Original file: Performance - Identify Overlapping Statistics (2008+).sql
...
Action:
    Review DROP STATISTICS suggestions carefully. Prefer dropping redundant auto-created stats when an equivalent index or user statistic already covers the leading column. Validate query plans after cleanup.
