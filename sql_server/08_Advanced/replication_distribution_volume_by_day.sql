/*
================================================================================
Distribution Agent Delivered Volume by Day
================================================================================
Description:
    Daily delivered-command volume from MSdistribution_history for capacity and trend analysis.

Source Attribution:
    Adapted from Kendal Van Dyke's SQL-Server-Scripts
    https://github.com/kendalvandyke/SQL-Server-Scripts
    Original file: Replication - Show Distribution Agent Volume By Day.sql
...
Action:
    Run on distributor. Sudden volume spikes correlate with large batch jobs or catch-up after outages.
