/*
================================================================================
Replication Subscription Topology (Distributor)
================================================================================
Description:
    Full distributor-side topology: publisher, publication, article, subscriber, destination DB, and agent profile.

Source Attribution:
    Adapted from Kendal Van Dyke's SQL-Server-Scripts
    https://github.com/kendalvandyke/SQL-Server-Scripts
    Original file: Replication - Show Subscriptions and Articles for All Subscribers at Distributor.sql
...
Action:
    Run on distributor. Use as inventory for DR, migration, and replication redesign.
