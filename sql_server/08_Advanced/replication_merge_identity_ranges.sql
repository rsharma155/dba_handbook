/*
================================================================================
Validate Merge Publication Identity Range Values
================================================================================
Description:
    Validates merge replication identity ranges and can suggest refresh/checkident actions.

Source Attribution:
    Adapted from Kendal Van Dyke's SQL-Server-Scripts
    https://github.com/kendalvandyke/SQL-Server-Scripts
    Original file: Replication - Validate Merge Publication Identity Range Values.sql
...
Action:
    Run on distributor. Only needed if merge replication is in use. Review before running any CHECKIDENT.
