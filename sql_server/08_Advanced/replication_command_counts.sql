/*
================================================================================
Replication Per-Article Command Counts (Distributor)
================================================================================
Description:
    Shows pending vs delivered commands per article at the distributor using MSrepl_commands vs agent xact_seqno. Deeper than subscription-level pending_commands in replication_monitor.sql.

Source Attribution:
    Adapted from Kendal Van Dyke's SQL-Server-Scripts
    https://github.com/kendalvandyke/SQL-Server-Scripts
    Original file: Replication - Show Command Counts At Distributor.sql
...
Action:
    Run on distributor. High pending counts on specific articles point to article-level backlog or filter issues.
