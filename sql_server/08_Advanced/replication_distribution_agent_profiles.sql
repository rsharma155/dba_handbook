/*
================================================================================
Distribution Agent Profiles by Subscriber
================================================================================
Description:
    Maps distribution agents to subscribers and their agent profiles.

Source Attribution:
    Adapted from Kendal Van Dyke's SQL-Server-Scripts
    https://github.com/kendalvandyke/SQL-Server-Scripts
    Original file: Replication - Show Distribution Agent Profiles for All Subscribers.sql
...
Action:
    Run on distributor. Verify profile settings (CommitBatchSize, etc.) match latency/throughput needs.
