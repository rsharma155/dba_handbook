/*
================================================================================
Log Reader Agent Volume by Day
================================================================================
Description:
    Daily log reader volume from MSlogreader_history.

Source Attribution:
    Adapted from Kendal Van Dyke's SQL-Server-Scripts
    https://github.com/kendalvandyke/SQL-Server-Scripts
    Original file: Replication - Show Logreader Agent Volume By Day.sql
...
Action:
    Run on distributor. Rising volume without matching distribution delivery indicates backlog risk.
