/*
================================================================================
Login Deletion Blockers (Users, Schemas, Objects, Jobs)
================================================================================
Description:
    Identifies hangups that prevent deleting a server login: mapped users, owned schemas, schema objects, and SQL Agent jobs. Includes HelperScript remediation suggestions.

Source Attribution:
    Adapted from Kendal Van Dyke's SQL-Server-Scripts
    https://github.com/kendalvandyke/SQL-Server-Scripts
    Original file: Security - Show Logins, Users, Schemas, and Jobs for Principal Name.sql
...
Action:
    Set @PrincipalName. Review HelperScript columns bottom-up (jobs → objects → schemas → users → login). Do not blindly execute suggested scripts — confirm ownership transfer first.
