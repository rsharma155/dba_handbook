/*
================================================================================
Show Database Role Membership and Object Permissions
================================================================================
Description:
    Read-only inventory of database role memberships and object-level permissions for a user (or all users). Fills the gap between posture audits and full permission scripting.

Source Attribution:
    Adapted from Kendal Van Dyke's SQL-Server-Scripts
    https://github.com/kendalvandyke/SQL-Server-Scripts
    Original file: Security - Show Database Level Permissions (2005+).sql
...
Action:
    Set @user to filter or NULL for all. Use for access reviews and before permission changes.
