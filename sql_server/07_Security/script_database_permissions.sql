/*
================================================================================
Script Database-Level Permissions (CREATE USER / Role / GRANT)
================================================================================
Description:
    Generates runnable T-SQL to recreate database users, role memberships, and object/database permissions. Critical for migration, DR rebuild, and permission documentation. Local authorization_audit.sql audits posture but does not script.

Source Attribution:
    Adapted from Kendal Van Dyke's SQL-Server-Scripts
    https://github.com/kendalvandyke/SQL-Server-Scripts
    Original file: Security - Script Database Level Permissions (2005+).sql
...
Action:
    Execute in the target database. Set @user to a principal name or NULL for all. Review output before applying on destination. Prefer after login scripting.
