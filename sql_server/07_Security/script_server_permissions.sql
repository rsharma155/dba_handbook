/*
================================================================================
Script Server-Level Permissions (Roles / GRANT)
================================================================================
Description:
    Generates runnable T-SQL for server role memberships and server-level GRANT statements. Complements inventory scripts that only SELECT permissions.

Source Attribution:
    Adapted from Kendal Van Dyke's SQL-Server-Scripts
    https://github.com/kendalvandyke/SQL-Server-Scripts
    Original file: Security - Script Server Level Permissions (2005+).sql
...
Action:
    Review and apply on destination after creating logins. Validate fixed-role memberships carefully in production.
