/*
================================================================================
Index Seek/Scan/Lookup Operators from Plan Cache
================================================================================
Description:
    Maps cached plan IndexScan/Seek/Lookup operators to specific indexes with query text and usage metrics. Complements dm_db_index_usage_stats which lacks query context.

Source Attribution:
    Adapted from Kendal Van Dyke's SQL-Server-Scripts
    https://github.com/kendalvandyke/SQL-Server-Scripts
    Original file: Performance - Find Index Seeks, Scans, & Lookups (2005+).sql
...
Action:
    Correlate high-scan indexes with query text. Consider covering indexes or query rewrites. Run off-peak — plan XML extraction is expensive.
