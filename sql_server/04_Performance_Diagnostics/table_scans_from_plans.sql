/*
================================================================================
Table Scans from Plan Cache
================================================================================
Description:
    Extracts TableScan operators from cached plans with query text, plan XML, and resource usage. More actionable than a boolean Has_TableScan flag.

Source Attribution:
    Adapted from Kendal Van Dyke's SQL-Server-Scripts
    https://github.com/kendalvandyke/SQL-Server-Scripts
    Original file: Performance - Find Table Scans (2005+).sql
...
Action:
    Investigate high-read table scans for missing indexes or unexpected heap scans. Prefer targeted indexes over blanket index creation. Run off-peak.
