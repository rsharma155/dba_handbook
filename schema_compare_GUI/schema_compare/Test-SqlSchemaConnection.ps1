# =============================================================================
# Module:   schema_compare/Test-SqlSchemaConnection.ps1
# Purpose:  Diagnoses SQL Server connectivity (protocol, port, auth, database)
#           before running Compare-SqlSchema.ps1.
# Author:   Ravi Sharma
# Created:  2026-05-22
