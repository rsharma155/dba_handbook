# =============================================================================
# Module:   schema_compare/Invoke-SchemaSyncPipeline.ps1
# Purpose:  Orchestrates schema comparison / sync across a Dev -> UAT -> Prod
#           promotion pipeline defined in config\environments.json.
# Author:   Ravi Sharma
# Created:  2026-05-22
