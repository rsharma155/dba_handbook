...
This folder is the PowerShell engine bundled with **SQL Optima Schema Compare**
(WinForms GUI in the parent folder — see `..\README.md`). You can also run the scripts
